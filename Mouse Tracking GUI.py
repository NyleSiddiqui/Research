        ...
        while flag:
            ...
            #     print(event.pos)
                ...
                if square.bottom > event.pos[1] > square.top and square.right > event.pos[0] > square.left:             # If user clicked in the square
                    if (pygame.mouse.get_pressed()[0] and det_button == 0) or \
                            (pygame.mouse.get_pressed()[1] and det_button == 1) or \
                            (pygame.mouse.get_pressed()[2] and det_button == 2):                                        # If the user clicked with the correct button
                        end = time.time()
